...
<head>
  ...
  <title>Lamborghini Huracán – Detalii</title>
  <style>
...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <div class="price">Preț: 229.000 €</div>
      <p class="desc">Un V10 aspirat care urcă în turații și un design dramatic — Huracán oferă emoție pură la fiecare accelerație și o ținută de drum impresionantă.</p>
      <ul>
        <li>Motor: 5.2 V10</li>
        <li>Putere: 640 CP</li>
      ...
      <div class="dealer">
        ...
        <p>Showroom modern în Pipera, cu zonă dedicată supercars și servicii premium.</p>
    <button class="btn ghost" onclick="window.location.href='parc_pipera.html'">Accesează parcul auto</button>
      </div>
