...
<head>
  ...
  <title>AutoPark Militari</title>
  <style>
    body { margin:0; font-family:Arial,sans-serif; color:#fff;
      background:linear-gradient(135deg,#0f0f10,#20232a); min-height:100vh;
      padding:40px 0; text-align:center;}
    .box{background:rgba(255,255,255,0.08);padding:28px;border-radius:16px;
      max-width:900px;width:clamp(300px,90vw,900px);margin:auto;}
    ...
    .btn{border:1px solid #7fd1ff;background:transparent;color:#7fd1ff;
      padding:10px 16px;border-radius:10px;cursor:pointer;transition:.3s;}
    .btn:hover{background:rgba(127,209,255,.15);}
    .separator{margin:24px 0 14px;border:none;border-top:1px solid rgba(255,255,255,0.2);}
    .modal-overlay{position:fixed;inset:0;background:rgba(0,0,0,.65);display:none;
      align-items:center;justify-content:center;z-index:9999;}
    .modal-content{background:#111827;border-radius:14px;padding:20px 22px;
      max-width:420px;width:90%;text-align:left;box-shadow:0 20px 40px rgba(0,0,0,.6);
      position:relative;}
    .modal-content h3{margin:0 0 10px;} .modal-content p{margin:6px 0;}
    .close-btn{position:absolute;top:8px;right:10px;border:none;background:transparent;
...
<body>
  <div class="box">
    <h1>AutoPark Militari</h1>
    <p>Adresă: Bd. Iuliu Maniu 200, București</p>
    <p>Program: L–V 09:00–19:00 • S 10:00–16:00</p>

    <div class="cta">
      <a class="btn" href="pagina_principala.php">Înapoi la listă</a>
      <a class="btn" href="parc_militari_masini.html">Vezi mașinile disponibile</a>
    </div>
