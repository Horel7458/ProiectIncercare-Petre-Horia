...
<head>
  ...
  <title>Porsche 911 Turbo S – Detalii</title>
  <style>
...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <div class="price">Preț: 189.900 €</div>
      <p class="desc">Turbo S redefinește ideea de supercar utilizabil zilnic: accelerație fulgerătoare, tracțiune impecabilă și un interior rafinat specific Porsche.</p>
      <ul>
        <li>Motor: 3.8 B6 twin-turbo</li>
        <li>Putere: 650 CP</li>
        <li>0–100 km/h: 2.7 s</li>
        <li>Tracțiune: AWD</li>
        <li>Cutie: PDK 8 trepte</li>
